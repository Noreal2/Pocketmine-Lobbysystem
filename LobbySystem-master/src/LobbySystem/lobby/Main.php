...
class Main extends PluginBase implements Listener{
	...
	public function onInteract(PlayerInteractEvent $ev)
	{
		...
		if ($item->getCustomName() == "§aInfos") {
			...
			$player->getInventory()->setItem(1, Item::get(267)->setCustomName("§e1vs1"));
			$player->getInventory()->setItem(2, Item::get(160)->setCustomName("§7-"));
			$player->getInventory()->setItem(3, Item::get(2)->setCustomName("§bCityBuild"));
			$player->getInventory()->setItem(4, Item::get(160)->setCustomName("§7-"));
			$player->getInventory()->setItem(5, Item::get(399)->setCustomName("§cSoupFFA"));
		...
		} elseif ($item->getCustomName() == "§e1vs1") {

			$player->sendMessage("");
			$player->sendMessage($this->prefix . Color::RED . " In Arbeit §e1vs1 §r");                        
			...
			$player->sendMessage($this->prefix . Color::RED . "Teleported to §bCityBuild §r");
                        $player->transfer("Atarove.ml","1");			
			
			} elseif ($item->getCustomName() == "§cFFA") {

			$player->sendMessage("");
			$player->sendMessage($this->prefix . Color::RED . "Teleported to §bFFA §r");
                        $player->transfer("Atarove.ml","2");

			} elseif ($item->getCustomName() == "§cSoupFFA") {

			$player->sendMessage("");
			$player->sendMessage($this->prefix . Color::RED . "Teleported to §bSoupFFA §r");
                        $player->transfer("Atarove.ml","3");
